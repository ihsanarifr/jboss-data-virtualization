...
INSERT INTO users VALUES ('user1','pass1'),('user2','pass2'),('user3','pass3'),('user4','pass4'),('user5','pass5'),('user6','pass6'),('user7','pass7');
INSERT INTO roles VALUES ('eu'),('us'),('ca'),('au'),('jp'),('br'),('za');

INSERT INTO users_roles VALUES ('user1','eu'),('user2','us'),('user3','ca'),('user4','au'),('user5','jp'),('user6','br'),('user7','za'),('user2','eu');

DROP DATABASE IF EXISTS bath;

create DATABASE bath;

\connect bath;

CREATE TABLE BathProducts (
...
INSERT INTO BathProducts VALUES 
('SP90756',4.79,'My Soap - Cherry Blossom'),
('SP90888',4.85,'My Soap - Clean Scent'),
('BT887',12.95,'Hand Towel - Beige'),
('BT888',13.95,'Hand Towel - White'),
('BT7045',44.95,'Bath Sheet - White');
...
INSERT INTO FoodProducts VALUES 
('04912509',3.50,'MyDrops - Strawberry Kiwi', 'FB'),
('884308770014',13.99,'Freeze-Dried Sweet Potatoes', 'FB'),
('082657500638',1.25,'HydePark Natural Spring Water - 16.9OZ', 'DXB'),
('182657522637',4.95,'MyTime Flour - 1lb', 'DXB'),
('232658512555',3.99,'Bentleys Griddle Mix', 'FB');
